...
to install can be defined by a variable.
...
## Other options
* `remote_tmp_path` - A path where downloaded scripts and other miscellaneous files can be stored for the duration of the job.